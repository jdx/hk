...
EXAMPLES = {
    ...
    "util/check-shebang-scripts-are-executable": ("Check that a script carrying a shebang is executable.",
    ...
    "util/destroyed-symlinks": ("Check the whole repository, or narrow the check to specific paths.",
